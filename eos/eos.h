...
#if (defined(EOS_TILLOTSON) || defined(EOS_ELASTIC) || defined(EOS_HELMHOLTZ) || defined(FLAG_NOT_IN_PUBLIC_CODE) || defined(EOS_TRUELOVE_PRESSURE) || defined(TRUELOVE_CRITERION_PRESSURE)) && !defined(EOS_GENERAL)
#define EOS_GENERAL
#endif
